...
import CredentialIdService from "../services/credential-id.service.js";
...
export class CredentialsController {
  ...
  generateCredential = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    const credentialId = await CredentialIdService.generateNextId(application.applicationType as any);
